...
export default function VideoPlayer() {
        ...
        api.get(`/videos/${id}`)
            .then(res => {
                ...
                if (currentUser) {
                    ...
                    setLiked(v.likedBy?.some(id => id?.toString() === uid) ?? false);
                }
    ...
    function canDelete(comment) {
        ...
        return currentUser._id?.toString() === comment.user?.toString() || currentUser.role === 'admin';
    }
    ...
    return (
        <div className="video-player-container">
            ...
            <div className="video-wrapper">
                <video key={videoSrc} controls autoPlay preload="metadata" playsInline className="styled-video" poster={video.thumbnailUrl}>
