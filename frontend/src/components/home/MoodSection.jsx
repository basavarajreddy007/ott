...
const genreColors = {
  Action: "#ff1e42", Comedy: "#FFD54F", Drama: "#64B5F6",
          ...
          <div className="mood-cards">
            {recommendations.map((movie, i) => (
              <div key={i} className="mood-card" style={{ animationDelay: `${i * 0.08}s` }}>
                <div className="mood-card-poster" style={{ background: `linear-gradient(135deg, ${genreColors[movie.genre] || "#ff1e42"}, ${genreColors[movie.genre] || "#ff1e42"}88)` }}>
